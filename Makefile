...
LDFLAGS=
EXEC=simGlobalEDF taskGenerator simEDF-k globalEDFvsEDFk
...
globalEDFvsEDFk: globalEDFvsEDFk.o taskGeneratorClass.o simEDFkClass.o simGlobalEDFClass.o task.o simulation.o job.o EDFComp.o
		$(CPP) -o $@ $^ $(LDFLAGS)
